...
private:
	friend class UDPSocket; // Allow the UDPSocket class to access private members of SocketAddress
	friend class TCPSocket;	// Allow the TCPSocket class to access private members of SocketAddress
